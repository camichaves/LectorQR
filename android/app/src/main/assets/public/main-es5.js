...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | pages-guardados-guardados-module */
        "guardados-guardados-module").then(__webpack_require__.bind(null,
        /*! ./pages/guardados/guardados.module */
        "./src/app/pages/guardados/guardados.module.ts")).then(function (m) {
          return m.GuardadosPageModule;
        });
      }
    }, // {
    //   path: 'mapa',
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ngx_qrcode2__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ngx-qrcode2 */
    ...
    var _services_historial_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    ...
    var _pages_mapa_mapa_page__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./pages/mapa/mapa.page */
    "./src/app/pages/mapa/mapa.page.ts");
    /* harmony import */


    var _pages_mapa_mapa_module__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
  ...
  /***/
  "./src/app/models/scanData.model.ts":
  /*!******************************************!*\
    !*** ./src/app/models/scanData.model.ts ***!
    \******************************************/

  /*! exports provided: ScanData */

  /***/
  function srcAppModelsScanDataModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ScanData", function () {
      return ScanData;
    });
    /* harmony import */
    ...
    var ScanData = function ScanData(texto) {
      _classCallCheck(this, ScanData);
  ...
  function srcAppPagesMapaMapaRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! @angular/router */
    "./node_modules/@angular/router/fesm2015/router.js"); // const routes: Routes = [
    //   {
    //     path: '/mapa',
    //     component: MapaPage
    //   }
  ...
  function srcAppPagesMapaMapaModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    MapaPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _mapa_routing_module__WEBPACK_IMPORTED_MODULE_5__["MapaPageRoutingModule"], _agm_core__WEBPACK_IMPORTED_MODULE_7__["AgmCoreModule"].forRoot({
        apiKey: 'AIzaSyDJTLIfUHhSd2hllr6UUjKdMHTeRUVejkk'
      })],
  ...
  function srcAppPagesMapaMapaPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)], MapaPage.prototype, "coords", void 0);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"]])], MapaPage);
    /***/
  },
  ...
  /***/
  function srcAppServicesHistorialServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _models_scanData_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../models/scanData.model */
    "./src/app/models/scanData.model.ts");
    /* harmony import */
    ...
    var _pages_mapa_mapa_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../pages/mapa/mapa.page */
    "./src/app/pages/mapa/mapa.page.ts");
    /* harmony import */
    ...
    function () {
      ...
      _createClass(HistorialService, [{
        ...
        value: function agregarHistorial(texto) {
          var data = new _models_scanData_model__WEBPACK_IMPORTED_MODULE_2__["ScanData"](texto);
        ...
        key: "abrirEscaneado",
        value: function abrirEscaneado(index) {
          var scanData = this.historial[index];

          switch (scanData.tipo) {
            case 'http':
              var browser = this.inAppBrowser.create(scanData.info);
              break;
        ...
        key: "crearContacto",
        value: function crearContacto(texto) {
          var _this3 = this;
          ...
          contact.name = new _ionic_native_contacts_ngx__WEBPACK_IMPORTED_MODULE_6__["ContactName"](null, name);
          contact.phoneNumbers = [new _ionic_native_contacts_ngx__WEBPACK_IMPORTED_MODULE_6__["ContactField"]('mobile', tel)];
          contact.save().then(function () {
            console.log('Contact saved!', contact);

            _this3.presentToast('Contacto ' + name + ' agregado');
          }, function (error) {
            console.error('Error saving contact.', error);

            _this3.presentToast('Error:' + error);
          });
        }
      }, {
        key: "presentToast",
        ...
        key: "parse_vcard",
        value: function parse_vcard(input) {
          var Re1 = /^(version|fn|title|org):(.+)$/i;
          var Re2 = /^([^:;]+);([^:]+):(.+)$/;
          var ReKey = /item\d{1,2}\./;
          var fields = {}; // tslint:disable-next-line:only-arrow-functions
          ...
          input.split(/\r\n|\r|\n/).forEach(function (line) {
            ...
            if (Re1.test(line)) {
              ...
              var meta = {};
              results[2].split(';') // tslint:disable-next-line:only-arrow-functions
              .map(function (p, i) {
        ...
        key: "abrirModalMapa",
        value: function abrirModalMapa(info) {
          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0,
          /*#__PURE__*/
                ...
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    return this.modalController.create({
                      component: _pages_mapa_mapa_page__WEBPACK_IMPORTED_MODULE_5__["MapaPage"],
                      componentProps: {
                        coords: info
                      }
                    });
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Camila\Documents\IONIC\QRAPP\version4\LectorQR\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
